...
public class DefaultUiFormElementOperationsStepDefs {
	...
	@Then("Verify that the following elements are not visible:")
	@Then("Verify that the following page objects are not visible:")
	@Then("Verify that the following page elements are not visible:")
	 ...
	 * @param po
	 */
	@Then("Verify {string} element is hidden.")
	@Then("Verify {string} page object is hidden.")
	@Then("Verify {string} page element is hidden.")
	...
	@Then("Verify {string} element is not visible.")
	@Then("Verify {string} page object is not visible.")
	@Then("Verify {string} page element is not visible.")
	@Then("Verify that {string} element is not visible.")
	@Then("Verify that {string} page object is not visible.")
